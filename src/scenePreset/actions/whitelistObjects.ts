...
export default function whitelistObjects(whitelistParameters: WhitelistParameters) {
    (whitelistParameters.objects || whitelistParameters.scene.children).forEach(object => {
