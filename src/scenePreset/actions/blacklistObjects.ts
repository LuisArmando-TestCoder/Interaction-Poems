...
export default function blacklistObjects(blacklistParameters: BlacklistParameters) {
    (blacklistParameters.objects || blacklistParameters.scene.children).forEach(object => {
